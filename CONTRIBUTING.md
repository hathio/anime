...
> **Personal note:** For my own workflow I also run `npm run test-browser` after every significant change in `/src`, not just at the end — caught a few subtle bugs early this way.
